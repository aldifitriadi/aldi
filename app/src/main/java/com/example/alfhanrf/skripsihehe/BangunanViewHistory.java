...
public class BangunanViewHistory extends BaseActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewAdapterBangunan = new RecycleViewAdapterBangunan(this, bangunan, true);
    ...
    public boolean onCreateOptionsMenu(android.view.Menu menu) {
        ...
        searchView.setOnQueryTextListener(BangunanViewHistory.this);
        return true;
    }
    ...
    public void loadDataBangunan() {
        ...
        Log.d("kocak", bangunan.toString());
        Log.d("hihi", userSession.getUserId());
...
//                }
                viewAdapterBangunan = new RecycleViewAdapterBangunan(BangunanViewHistory.this, bangunan, true);
                recyclerView.setAdapter(viewAdapterBangunan);
    ...
    public boolean onQueryTextSubmit(String query) {
        UserSession userSession = new UserSession(BangunanViewHistory.this);
        APIInterface apiInterface = APIClient.getClientAuthorize().create(APIInterface.class);
...
//                        bgn.setLuas_basement(data.get("luas_basement").getAsString());
                        ...
                        viewAdapterBangunan = new RecycleViewAdapterBangunan(BangunanViewHistory.this, bangunan, false);
                        viewAdapterBangunan.notifyDataSetChanged();
                        recyclerView.setAdapter(viewAdapterBangunan);
...
//
//            APIInterface apiInterface = APIClient.getClientAuthorize().create(APIInterface.class);
//            Call<BangunanList> call = apiInterface.search(newText);
//            call.enqueue(new Callback<BangunanList>() {
//
//                @Override
//                public void onResponse(Call<BangunanList> call, Response<BangunanList> response) {
//
//                    Log.d("post kata", bangunan.toString());
//
//                        recyclerView.setVisibility(View.VISIBLE);
//
//                        bangunan = response.body().getSemuaBangunan();
//                        viewAdapterBangunan = new RecycleViewAdapterBangunan(BangunanView.this, bangunan);
//                        recyclerView.setAdapter(viewAdapterBangunan);
//
//                    }
//
